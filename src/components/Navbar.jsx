          ...
          <div className="flex items-center justify-between mx-auto max-w-7xl h-16 max-[1340px]:px-12">
            ...
            <div className="flex items-center gap-12">
              <ul className=" font-bold gap-5 items-center hidden md:flex">
                ...
                <li>
                  <NavLink style={NavLinkStyles} to="/browse">
                    Browse
                  </NavLink>
                </li>
              </ul>
              {!user ? (
                <div className="hidden md:block gap-4">
                  <Link to="/login">
                    <button className="mx-2 bg-slate-100 h-[40px] w-[80px] border-none  rounded-lg font-semibold">
                      Login
                    </button>
                  </Link>
                  <Link to="/signup">
                    <button className="mx-2 bg-green-600 text-white h-[40px] w-[80px] border-none  rounded-lg font-semibold ">
                      SignUp
                    </button>
                  </Link>
                </div>
          ...
          {nav ? (
            <>
              ...
              <div className="flex  flex-col items-center md:hidden mt-8">
                <div>
                  <Link to="/login">
                    <button className="mx-2 bg-slate-100 h-[40px] w-[80px] border-2  rounded-lg font-semibold">
                      Login
                    </button>
                  </Link>
                  <Link to="/signup">
                    <button className="mx-2 bg-green-600 text-white h-[40px] w-[80px] border-2  rounded-lg font-semibold ">
                      SignUp
                    </button>
                  </Link>
                </div>
