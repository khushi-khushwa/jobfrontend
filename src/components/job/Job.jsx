    ...
    <div className=" flex justify-center align-center">
      <div className="shadow p-5 max-[1420px]:p-4  hover:shadow-emerald-300  ">
        ...
        <div className="mt-5 flex gap-4">
          <div className="h-14 w-[0.3rem] rounded-s-md bg-emerald-200"></div>
        ...
        <div className="flex items-center gap-4 mt-9">
          <button onClick= {() =>  navigate(`/description/${JobId}`)} className="h-7 w-24 p-1  max-[455px]:w-20  max-[1420px]:w-20 flex items-center justify-center bg-emerald-50 rounded-lg max-[455px]:text-sm max-[1420px]:text-sm">
            Details
          </button>
